...
class _CourseSearchPageState extends State<CourseSearchPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      _initialCategoryId = args?['categoryId'] as String?;
      if (!mounted) return;
      final vm = Provider.of<HomeViewModel>(context, listen: false);
      await vm.initialize();
      if (_initialCategoryId != null && _initialCategoryId!.isNotEmpty) {
        _showCategoryList = true;
        await vm.fetchCoursesByCategory(_initialCategoryId!);
        if (mounted) setState(() {});
      }
    });
  }
            ...
            children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: const Text('Tắt lọc'),
                      ),
                    ],
                  ),
                ),
              if (!_showCategoryList && vm.isSearching)
                const Padding(
              ...
              Expanded(
                child: _showCategoryList
                    ? (vm.isLoadingLatestCourses || vm.isLoadingCategoryCourses
                          ? const Center(child: CircularProgressIndicator())
                          : (vm.categoryCourses.isEmpty
                                ? Center(
                                    child: Text(
                                ...
                                : ListView.builder(
                                    ...
                                    itemCount: vm.categoryCourses.length,
                                    itemBuilder: (context, index) {
                                      final course = vm.categoryCourses[index];
                                      return Padding(
